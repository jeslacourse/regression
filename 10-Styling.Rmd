...
With the help of Bookdown, the Rmarkdown Cookbook, and a little Office Ipsum. [*Markdown Extensions*](https://bookdown.org/yihui/bookdown/markdown-extensions-by-bookdown.html)
...
This is another sample problem. There may be a mix of plain text and LaTex. Use `.example .example2` tags. 
...
::: {.definition .defn }
This is a definition in a callout. The numbering is reliant on Pandocs internal `.definition` class. Use `.definition .defn` to build with the definition numbering, or just `.defn` for the box without. 
:::
